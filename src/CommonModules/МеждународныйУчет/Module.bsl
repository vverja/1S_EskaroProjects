...
Функция ПреобразоватьСчетаБУвСчетМСФО(СчетБУ, Субконто1 = Неопределено, Субконто2 = Неопределено, Субконто3 = Неопределено, Знач ДатаСреза = Неопределено, ПолучитьВсеСоответствия = Ложь) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |
	               |УПОРЯДОЧИТЬ ПО
 				   |	СоответствиеСчетовСрезПоследних.Приоритет.Порядок УБЫВ";
