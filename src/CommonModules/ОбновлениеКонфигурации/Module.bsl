...
//
// Параметры
//   ВыдаватьСообщения  – Булево – определеяет, может ли функция выводить 
...
Функция АдресСтраницыИнформацииОПолученииДоступаКПользовательскомуСайту() Экспорт
	Возврат "users.v8.1c.ru/Rules.aspx";
КонецФункции 
...
//  УспешноеОбновление  – Булево – признак того, успешное или неусспешное обновление.
//
...
Процедура ОтправитьЭлектроннуюПочту(Знач ИмяПользователя, 
	...
	ВызватьИсключение "Отсуствует возможность отправки электронной почты."; 	
...
Процедура ПриПереходеНаСтраницуПомощника(ПомощникОбновления, ПредыдущаяСтраница, СледующаяСтраница, Отказ) Экспорт
	...
	#Если Клиент Тогда
	Если ПредыдущаяСтраница = "ФайлОбновления" И СледующаяСтраница <> "ФайлОбновления" И ПомощникОбновления.ИсточникОбновления = 2 
