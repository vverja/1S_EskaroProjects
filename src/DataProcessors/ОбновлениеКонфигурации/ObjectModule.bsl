...
Процедура ВосстановитьНастройкиОбновления() Экспорт
	...
	// СоздатьСосединениеЧерезПрокси() обработки ПолучениеФайловИзИнтернета.
...
// Проверка, что файл является дистибутивом обновления.
//
// Параметр:
//  ПутьКФайлу   - Строка - путь к файлу.
//
// Возвращаемое значение:
//  Булево - Истина, если файл является дистибутивом обновления.
//
...
Функция ПолучитьДоступныеОбновленияВИнтервале(Знач ВерсияОт, Знач ВерсияДо) 
	...
	Пока ТекущаяВерсияОт <> ВерсияДо Цикл
		...
		ТекущаяВерсияОт = ДоступноеОбновление.Версия;
...
Процедура ПолучитьДоступныеОбновления(ПараметрыОбновления, ВерсияКонфигурации)Экспорт
...
// Выпонить обновление конфигурации.
//
