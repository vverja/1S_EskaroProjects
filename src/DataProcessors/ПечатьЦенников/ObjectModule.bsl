...
Процедура ЗаполнитьПостроительОтчета() Экспорт
	...
	| 	СпрНоменклатура.Номенклатура.Артикул,
	...
	СоответствиеДоступныхОтборов.Вставить("Артикул", 0);
...
//
Процедура ПерезаполнитьЦены(ДатаФормированияЦен = Неопределено) Экспорт
	...
	ЗапросПоЦенам = Ценообразование.СформироватьЗапросПоЦенам(СтруктураЗначений,
	   ...
	   ?(ДатаФормированияЦен = Неопределено, РабочаяДата, ДатаФормированияЦен),
	...
	Для Каждого СтрокаТаблицы Из Товары Цикл
		Если СтрокаТаблицы.Печать Тогда
			Для Тмп = 1 По СтрокаТаблицы.Количество Цикл
				...
				ОбластьЦенника.Параметры.Артикул      					 = СтрокаТаблицы.Артикул;
