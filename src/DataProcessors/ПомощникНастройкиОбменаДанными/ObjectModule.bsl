...
Функция НужныОграниченияПоОрганизации() Экспорт
	...
	Возврат ТипИнформационнойБазыДляОбмена = "ОбменУППУПП";
...
мТаблицаВозможныхОбменов = ПараметрыОбменаДанными.ПолучитьТаблицуВозможныхОбменов();
мСтруктураИнформацииОТекущейИнформационнойБазе = ПараметрыОбменаДанными.ПолучитьИнформациюОТекущейИнформационнойБазе();
