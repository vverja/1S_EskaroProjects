...
Процедура НачатьРаботу() Экспорт
	...
	мСерверТО.ПодключитьКлиента(ЭтотОбъект);
...
Процедура ЗавершитьРаботу() Экспорт
	...
	мСерверТО.ОтключитьКлиента(ЭтотОбъект);
...
Процедура ВнешнееСобытие(Источник, Событие, Данные) Экспорт
	...
	мСерверТО.ОбработатьВнешнееСобытие(Событие, Данные, ЭтотОбъект);
...
Процедура ЗакрытиеЧекаККМ(Товары, ПризнакВозврата, СуммаНал, СуммаБезнал,
	...
	ДокЧек.КассаККМ       = мСерверТО.ПолучитьКассуККМ(ККМ);
