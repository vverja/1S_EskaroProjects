...
Процедура ПроверитьЗаполнениеТабличнойЧастиЗаказы(ТаблицаПоТоварам, ВыборкаПоШапкеДокумента, 
	...
	Для Каждого СтрокаТЧ Из Заказы Цикл
		...
		Если ПроверитьОрганизацию Тогда
			Если СтрокаТЧ.ЗаказПоставщику.Организация <> Организация Тогда
...
//  Заголовок                 - строка, заголовок сообщения об ошибке проведения.
//
Процедура ДвиженияПоРегистрам(РежимПроведения, ВыборкаПоШапкеДокумента, ТаблицаПоЗаказамПокупателей, ТаблицаПоЗаказамПоставщикам, ТаблицаПоРазмещениюЗаказовПокупателей, 
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если Не Отказ Тогда
		...
		ДвиженияПоРегистрам(РежимПроведения, СтруктураШапкиДокумента, ТаблицаПоЗаказамПокупателей, ТаблицаПоЗаказамПоставщикам, ТаблицаПоРазмещениюЗаказовПокупателей,
							ТаблицаПоРасчетам, Отказ, Заголовок);
