...
Процедура ЗаполнитьТоварыПоПоступлениюТоваровУпр(ДокументОснование, ИмяТЧ = "Товары") Экспорт
	...
	|	" + ?(ИмяТЧ = "БланкиСтрогогоУчета", "МАКСИМУМ(Остатки.КоличествоОстаток) КАК КоличествоОстатокКомпании", 
	...
	|	" + ?(ИмяТЧ = "БланкиСтрогогоУчета", "Док.Коэффициент ", 
											 "Док.Коэффициент,
...
КонецПроцедуры // ДвиженияПоТоварамОрганизацийРегл()
