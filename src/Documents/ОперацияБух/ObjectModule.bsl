...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Пока ДвиженияНУ.Следующий() Цикл
		...
		Проводка.ВалютаДт        = ДвиженияНУ.ВалютаДт;
		Проводка.ВалютаКт        = ДвиженияНУ.ВалютаКт;
		Проводка.ВалютнаяСуммаДт = ДвиженияНУ.ВалютнаяСуммаДт;
		Проводка.ВалютнаяСуммаКт = ДвиженияНУ.ВалютнаяСуммаКт;
