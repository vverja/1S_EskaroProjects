...
Функция РассчитыватьАвтоматическиеСкидки(ТекВид)
	...
	ИначеЕсли ТекВид = Перечисления.УсловияСкидкиНаценки.ПоСуммеТовараДокумента Тогда
		Результат = ИспользованиеСкидок.ИспользоватьСкидкиПоСуммеДокумента;
	ИначеЕсли ТекВид = Перечисления.УсловияСкидкиНаценки.ПоСуммеТовараДокумента2 Тогда
		Результат = ИспользованиеСкидок.ИспользоватьСкидкиПоСуммеНеВСпискеТовараДокумента;
