...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если РольДоступна("ГруппаА") Тогда
		НПТ = НПТ + " ГДЕ Организация <> &НПТ ";	
	КонецЕсли;
	ТекстЗапроса = ТекстЗапроса + НПТ
	+ "{ГДЕ
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("ВЫБОР КОГДА ДвиженияДенежныхСредствОбороты.ДокументПланированияПлатежа = НЕОПРЕДЕЛЕНО ИЛИ ДвиженияДенежныхСредствОбороты.ДокументПланированияПлатежа.ЦФО = &ПустойЦФО ТОГДА ДвиженияДенежныхСредствОбороты.ДокументДвижения.Подразделение ИНАЧЕ ДвиженияДенежныхСредствОбороты.ДокументПланированияПлатежа.ЦФО КОНЕЦ", "Подразделение", "Подразделение", ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_Подразделения);
