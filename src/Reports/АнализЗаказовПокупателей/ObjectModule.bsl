...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	|	ЗапрещенныеКОтгрузке.Количество КАК КоличествоЗапрещенныхКОтгрузке,
	|	ЗапрещенныеКОтгрузке.Сумма КАК СуммаЗапрещенныхКОтгрузке
	|   //ПОЛЯ_СВОЙСТВА
	|	//ПОЛЯ_КАТЕГОРИИ
	|{ВЫБРАТЬ
	...
	|	КоличествоЗапрещенныхКОтгрузке,
	|	СуммаЗапрещенныхКОтгрузке
	|   //ПСЕВДОНИМЫ_СВОЙСТВА
	...
	|			ЗаказПокупателяТовары.ЗапрещенКОтгрузке КАК ЗапрещенКОтгрузке,
	|			СУММА(ЗаказПокупателяТовары.Сумма) КАК Сумма
	|		ИЗ
	|			Документ.ЗаказПокупателя.Товары КАК ЗаказПокупателяТовары
	|		ГДЕ
	|			ЗаказПокупателяТовары.ЗапрещенКОтгрузке = ИСТИНА
	|		
	|		СГРУППИРОВАТЬ ПО
	|			ЗаказПокупателяТовары.Ссылка,
	|			ЗаказПокупателяТовары.Номенклатура,
	|			ЗаказПокупателяТовары.ЗапрещенКОтгрузке) КАК ЗапрещенныеКОтгрузке
	|		ПО ЗаказыПокупателейОстаткиИОбороты.ЗаказПокупателя = ЗапрещенныеКОтгрузке.Ссылка
	|			И ЗаказыПокупателейОстаткиИОбороты.Номенклатура = ЗапрещенныеКОтгрузке.Номенклатура
	|//СОЕДИНЕНИЯ
	|
	|{ГДЕ
	|	ЗаказыПокупателейОстаткиИОбороты.СтатусПартии.* КАК СтатусПартии,
	...
	|	СУММА(КоличествоЗапрещенныхКОтгрузке),
	|	СУММА(СуммаЗапрещенныхКОтгрузке)
	|ПО
	|	ОБЩИЕ,
	|	ДоговорКонтрагентаВладелец,
	|	ДоговорКонтрагента,
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоЗапрещенныхКОтгрузке", "Осталось обеспечить (в ед. хранения) по причине запрещено");	
	...
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоЗапрещенныхКОтгрузке", "Осталось обеспечить по причине запрещено", Истина, "ЧЦ=15; ЧДЦ=3", "Запрещенные", "Запрещенные (в ед. хранения)");
