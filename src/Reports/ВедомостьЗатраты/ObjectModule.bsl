...
Процедура УстановитьНачальныеНастройкиУпр(ДополнительныеПараметры = Неопределено)
	...
	УниверсальныйОтчет.ИмяРегистра = "Затраты";
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаОборот", "Оборот", Ложь, "ЧЦ=15; ЧДЦ=2", "Сумма", "Сумма");
...
Процедура УстановитьНачальныеНастройкиБух(ДополнительныеПараметры = Неопределено)
	...
	// Пример:
	// УниверсальныйОтчет.ИмяРегистра = "ТоварыНаСкладах";
	УниверсальныйОтчет.ИмяРегистра = "ЗатратыБухгалтерскийУчет";
...
Процедура УстановитьНачальныеНастройкиМСФО(ДополнительныеПараметры = Неопределено)
	...
	// Пример:
	// УниверсальныйОтчет.ИмяРегистра = "ТоварыНаСкладах";
	УниверсальныйОтчет.ИмяРегистра = "ЗатратыМеждународныйУчет";
