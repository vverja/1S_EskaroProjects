...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	ТекстЗапроса = 
		...
		|	РегМатериалы.Качество,
		|	РегМатериалы.СхемаНазначенияИспользования,
		|	РегМатериалы.СпособОтраженияРасходов,
		|	РегМатериалы.СрокПолезногоИспользования,
		...
		|		 СрокПолезногоИспользования.* 	  КАК СрокПолезногоИспользования}) КАК РегМатериалы
		|	//СОЕДИНЕНИЯ
		|{ГДЕ
		|	РегМатериалы.КоличествоНачальныйОстаток КАК КолНачОст,
		|	РегМатериалы.КоличествоКонечныйОстаток КАК КолКонОст,
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "СхемаНазначенияИспользования",   "Схема назначения использования");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "СпособОтраженияРасходов",    	"Способ отражения расходов");
