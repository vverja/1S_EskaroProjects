...
Процедура УстановитьНачальныеНастройкиУпр(ДополнительныеПараметры = Неопределено)
	...
	|//СОЕДИНЕНИЯ" +  Символы.ПС; 
	НПТ = "";
	Если РольДоступна("ГруппаА") ТОГДА 
		НПТ = Символы.ПС + " ГДЕ НЕ ДокументОприходования.Ссылка.Представление ЕСТЬ NULL И ДокументОприходования.Организация <> &НПТ ";	
		Если Найти(ТекстЗапроса, "ИсточникДанных.Регистратор") <> 0 Тогда
			НПТ = НПТ + " И ИсточникДанных.Регистратор.Организация <> &НПТ ";
		КонецЕсли;
	КонецЕсли;
	ТекстЗапроса = ТекстЗапроса + НПТ + "{ГДЕ
	|	ИсточникДанных.КоличествоНачальныйОстаток КАК КоличествоНачальныйОстаток,
	|	ИсточникДанных.КоличествоНачальныйОстаток * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент / ИсточникДанных.Номенклатура.ЕдиницаДляОтчетов.Коэффициент КАК КоличествоНачальныйОстатокВЕдиницахДляОтчетов,
	|	ИсточникДанных.КоличествоНачальныйОстаток * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент КАК КоличествоНачальныйОстатокВБазовыхЕдиницах,
	|	ИсточникДанных.КоличествоПриход КАК КоличествоПриход,
...
Процедура УстановитьНачальныеНастройкиБух(ДополнительныеПараметры = Неопределено)
	...
	|	ИсточникДанных.Качество КАК Качество,
	|	ПРЕДСТАВЛЕНИЕ(ИсточникДанных.Качество),
	|	ИсточникДанных.НалоговоеНазначение КАК НалоговоеНазначение,
	|	ПРЕДСТАВЛЕНИЕ(ИсточникДанных.НалоговоеНазначение),
	|	ИсточникДанных.КоличествоНачальныйОстаток КАК КоличествоНачальныйОстаток,
	|	ИсточникДанных.КоличествоНачальныйОстаток * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент / ИсточникДанных.Номенклатура.ЕдиницаДляОтчетов.Коэффициент КАК КоличествоНачальныйОстатокВЕдиницахДляОтчетов,
	|	ИсточникДанных.КоличествоНачальныйОстаток * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент КАК КоличествоНачальныйОстатокВБазовыхЕдиницах,
	|	ИсточникДанных.КоличествоПриход КАК КоличествоПриход,
	...
	|	ИсточникДанных.СтоимостьРасход КАК СтоимостьРасход,
	|	ИсточникДанных.СтоимостьКонечныйОстаток КАК СтоимостьКонечныйОстаток,
	|	ИсточникДанных.СтоимостьНУНачальныйОстаток КАК СтоимостьНУНачальныйОстаток,
	|	ИсточникДанных.СтоимостьНУПриход КАК СтоимостьНУПриход,
	|	ИсточникДанных.СтоимостьНУРасход КАК СтоимостьНУРасход,
	|	ИсточникДанных.СтоимостьНУКонечныйОстаток КАК СтоимостьНУКонечныйОстаток,
	|	ИсточникДанных.НДСВходящийНачальныйОстаток 	  КАК НДСВходящийНачальныйОстаток,
	|	ИсточникДанных.НДСВходящийПриход           	  КАК НДСВходящийПриход,
	|	ИсточникДанных.НДСВходящийРасход			  КАК НДСВходящийРасход,
	|	ИсточникДанных.НДСВходящийКонечныйОстаток  	  КАК НДСВходящийКонечныйОстаток,
	|	ИсточникДанных.НДСКредитНачальныйОстаток 	  КАК НДСКредитНачальныйОстаток,
	|	ИсточникДанных.НДСКредитПриход           	  КАК НДСКредитПриход,
	|	ИсточникДанных.НДСКредитРасход				  КАК НДСКредитРасход,
	|	ИсточникДанных.НДСКредитКонечныйОстаток  	  КАК НДСКредитКонечныйОстаток,
	|	ИсточникДанных.Регистратор КАК Регистратор,
	|	ПРЕДСТАВЛЕНИЕ(ИсточникДанных.Регистратор),
	|	ИсточникДанных.Период КАК Период,
	|	НачалоПериода(ИсточникДанных.Период, День) КАК ПериодДень,
	...
	|	СтоимостьРасход,
	|	СтоимостьКонечныйОстаток,
	|	СтоимостьНУНачальныйОстаток КАК СтоимостьНУНачальныйОстаток,
	|	СтоимостьНУПриход КАК СтоимостьНУПриход,
	|	СтоимостьНУРасход КАК СтоимостьНУРасход,
	|	СтоимостьНУКонечныйОстаток,
	|	НДСВходящийНачальныйОстаток,
	|	НДСВходящийПриход,
	|	НДСВходящийРасход,
	|	НДСВходящийКонечныйОстаток,
	|	НДСКредитНачальныйОстаток,
	|	НДСКредитПриход,
	|	НДСКредитРасход,
	|	НДСКредитКонечныйОстаток,
    |	Регистратор.*,
	|	Период,
	|	ПериодДень,
	|	ПериодНеделя,
	...
	|	НалоговоеНазначение.*}) КАК ИсточникДанных
	|//СОЕДИНЕНИЯ
	|{ГДЕ
	|	ИсточникДанных.КоличествоНачальныйОстаток КАК КоличествоНачальныйОстаток,
	|	ИсточникДанных.КоличествоНачальныйОстаток * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент / ИсточникДанных.Номенклатура.ЕдиницаДляОтчетов.Коэффициент КАК КоличествоНачальныйОстатокВЕдиницахДляОтчетов,
	...
	|	СУММА(СтоимостьРасход),
	|	СУММА(СтоимостьКонечныйОстаток),
	|	СУММА(СтоимостьНУНачальныйОстаток),
	|	СУММА(СтоимостьНУПриход),
	|	СУММА(СтоимостьНУРасход),
	|	СУММА(СтоимостьНУКонечныйОстаток),
	|	СУММА(НДСВходящийНачальныйОстаток),
	|	СУММА(НДСВходящийПриход),
	|	СУММА(НДСВходящийРасход),
	|	СУММА(НДСВходящийКонечныйОстаток),
	|	СУММА(НДСКредитНачальныйОстаток),
	|	СУММА(НДСКредитПриход),
	|	СУММА(НДСКредитРасход),
	|	СУММА(НДСКредитКонечныйОстаток)
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьНачальныйОстаток","Стоимость начальный остаток");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьНУНачальныйОстаток","Стоимость начальный остаток нал. учет");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("НДСВходящийНачальныйОстаток",  	 "Сумма входящего НДС (нач. остаток)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("НДСКредитНачальныйОстаток",  		 "Сумма налогового кредита (нач. остаток)");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьПриход","Стоимость приход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьНУПриход","Стоимость приход нал. учет");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьРасход","Стоимость расход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьНУРасход","Стоимость расход нал. учет");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьКонечныйОстаток","Стоимость конечный остаток");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьНУКонечныйОстаток","Стоимость конечный остаток нал. учет");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("НДСВходящийКонечныйОстаток", 		 "Сумма входящего НДС (кон. остаток)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("НДСКредитКонечныйОстаток",  		 "Сумма налогового кредита (кон. остаток)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоНачальныйОстатокВБазовыхЕдиницах","Количество (в базовых ед.)", Ложь, "ЧЦ=15; ЧДЦ=3", "НачальныйОстаток", "Начальный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьНачальныйОстаток","Стоимость", Истина, "ЧЦ=15; ЧДЦ=2", "НачальныйОстаток", "Начальный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьНУНачальныйОстаток","Стоимость нал. учет", Истина, "ЧЦ=15; ЧДЦ=2", "НачальныйОстаток", "Начальный остаток");
    УниверсальныйОтчет.ДобавитьПоказатель("НДСВходящийНачальныйОстаток",  	  "Сумма входящего НДС", Ложь, "ЧЦ=15; ЧДЦ=2", "НачальныйОстаток", "Начальный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("НДСКредитНачальныйОстаток",	  	  "Сумма налогового кредита", Ложь, "ЧЦ=15; ЧДЦ=2", "НачальныйОстаток", "Начальный остаток");	
    	
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоПриход","Количество", Истина, "ЧЦ=15; ЧДЦ=3", "Приход", "Приход");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоПриходВЕдиницахДляОтчетов","Количество (в ед. отчетов)", Ложь, "ЧЦ=15; ЧДЦ=3", "Приход", "Приход");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоПриходВБазовыхЕдиницах","Количество (в базовых ед.)", Ложь, "ЧЦ=15; ЧДЦ=3", "Приход", "Приход");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьПриход","Стоимость", Истина, "ЧЦ=15; ЧДЦ=2", "Приход", "Приход");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьНУПриход","Стоимость нал. учет", Истина, "ЧЦ=15; ЧДЦ=2", "Приход", "Приход");
    УниверсальныйОтчет.ДобавитьПоказатель("НДСВходящийПриход",  	  "Сумма входящего НДС", Ложь, "ЧЦ=15; ЧДЦ=2", "Приход", "Приход");
	УниверсальныйОтчет.ДобавитьПоказатель("НДСКредитПриход",	  	  "Сумма налогового кредита", Ложь, "ЧЦ=15; ЧДЦ=2", "Приход", "Приход");	

	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоРасход","Количество", Истина, "ЧЦ=15; ЧДЦ=3", "Расход", "Расход");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоРасходВЕдиницахДляОтчетов","Количество (в ед. отчетов)", Ложь, "ЧЦ=15; ЧДЦ=3", "Расход", "Расход");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоРасходВБазовыхЕдиницах","Количество (в базовых ед.)", Ложь, "ЧЦ=15; ЧДЦ=3", "Расход", "Расход");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьРасход","Стоимость", Истина, "ЧЦ=15; ЧДЦ=2", "Расход", "Расход");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьНУРасход","Стоимость нал. учет", Истина, "ЧЦ=15; ЧДЦ=2", "Расход", "Расход");
    УниверсальныйОтчет.ДобавитьПоказатель("НДСВходящийРасход",  	  "Сумма входящего НДС", Ложь, "ЧЦ=15; ЧДЦ=2", "Расход", "Расход");
	УниверсальныйОтчет.ДобавитьПоказатель("НДСКредитРасход",	  	  "Сумма налогового кредита", Ложь, "ЧЦ=15; ЧДЦ=2", "Расход", "Расход");	

	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоКонечныйОстаток", "Количество", Истина, "ЧЦ=15; ЧДЦ=3", "КонечныйОстаток", "Конечный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоКонечныйОстатокВЕдиницахДляОтчетов","Количество (в ед. отчетов)", Ложь, "ЧЦ=15; ЧДЦ=3", "КонечныйОстаток", "Конечный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоКонечныйОстатокВБазовыхЕдиницах","Количество (в базовых ед.)", Ложь, "ЧЦ=15; ЧДЦ=3", "КонечныйОстаток", "Конечный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьКонечныйОстаток","Стоимость", Истина, "ЧЦ=15; ЧДЦ=2", "КонечныйОстаток", "Конечный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьНУКонечныйОстаток","Стоимость нал. учет", Истина, "ЧЦ=15; ЧДЦ=2", "КонечныйОстаток", "Конечный остаток");
    УниверсальныйОтчет.ДобавитьПоказатель("НДСВходящийКонечныйОстаток",  	  "Сумма входящего НДС", Ложь, "ЧЦ=15; ЧДЦ=2", "КонечныйОстаток", "Конечный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("НДСКредитКонечныйОстаток",	  	  "Сумма налогового кредита", Ложь, "ЧЦ=15; ЧДЦ=2", "КонечныйОстаток", "Конечный остаток");	
...
Процедура УстановитьНачальныеНастройкиМСФО(ДополнительныеПараметры = Неопределено)
	...
	|	//ПСЕВДОНИМЫ_КАТЕГОРИИ
	|}
	|ИЗ РегистрНакопления.ПартииТоваровНаСкладахМеждународныйУчет.ОстаткиИОбороты(&ДатаНач, &ДатаКон, Регистратор {&Периодичность},, {
	|	Номенклатура.* КАК Номенклатура,
	|	СчетУчета.* КАК СчетУчета,
	|	Организация.* КАК Организация,
	|	Склад.* КАК Склад,
...
Функция ПолучитьТекстСправкиФормы() Экспорт
	...
	Если глЗначениеПеременной("ИспользоватьРасширеннуюАналитикуУчетаНоменклатурыИЗатрат") Тогда
		...
		ТекстСправкиФормы = "<P>С " + НачалоИспользования + " установлено использование расширенной аналитики учета затрат."
					...
					+ "<BR>Можно воспользоваться отчетом ""Ведомость по учету МПЗ"".<P>";
	КонецЕсли; 
