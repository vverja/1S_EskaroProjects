...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ИмяРегистра = "ТоварыВНТТ";
	...
	УниверсальныйОтчет.ДобавитьПолеРесурс("СуммаВРозницеНачальныйОстаток",     "ВЫРАЗИТЬ(ИсточникДанных.КоличествоНачальныйОстаток * ИсточникДанных.ЦенаВРознице КАК ЧИСЛО(15, 2))", "Стоимость в рознице (нач. ост.)");
	УниверсальныйОтчет.ДобавитьПолеРесурс("СуммаВРозницеПриход",               "ВЫРАЗИТЬ(ИсточникДанных.КоличествоПриход           * ИсточникДанных.ЦенаВРознице КАК ЧИСЛО(15, 2))", "Стоимость в рознице (приход)");
	УниверсальныйОтчет.ДобавитьПолеРесурс("СуммаВРозницеРасход",               "ВЫРАЗИТЬ(ИсточникДанных.КоличествоРасход           * ИсточникДанных.ЦенаВРознице КАК ЧИСЛО(15, 2))", "Стоимость в рознице (расход)");
	УниверсальныйОтчет.ДобавитьПолеРесурс("СуммаВРозницеКонечныйОстаток",      "ВЫРАЗИТЬ(ИсточникДанных.КоличествоКонечныйОстаток  * ИсточникДанных.ЦенаВРознице КАК ЧИСЛО(15, 2))", "Стоимость в рознице (кон. ост.)");
	УниверсальныйОтчет.ДобавитьПолеРесурс("СуммаВРозницеОборот",               "ВЫРАЗИТЬ(ИсточникДанных.КоличествоОборот           * ИсточникДанных.ЦенаВРознице КАК ЧИСЛО(15, 2))", "Стоимость в рознице (оборот)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВРозницеНачальныйОстаток", "Начальный остаток", Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВРознице", "Стоимость в рознице");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВРозницеПриход",           "Приход",            Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВРознице", "Стоимость в рознице");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВРозницеРасход",           "Расход",            Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВРознице", "Стоимость в рознице");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВРозницеКонечныйОстаток",  "Конечный остаток",  Истина, "ЧЦ=15; ЧДЦ=2", "СуммаВРознице", "Стоимость в рознице");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаВРозницеОборот",           "Оборот",              Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаВРознице", "Стоимость в рознице");
	...
	УниверсальныйОтчет.УстановитьСвязьПоляИИзмерения("БазоваяЕдиницаИзмерения", "Номенклатура");
	//УниверсальныйОтчет.УстановитьСвязьПоляИИзмерения("СуммаВРознице",           "ЦенаВРознице");
	
	// Добавление дополнительных полей
	// Необходимо вызывать для каждого добавляемого дополнительного поля.
	// УниверсальныйОтчет.ДобавитьДополнительноеПоле(<ПутьКДанным>, <Размещение>, <Положение>);
	УниверсальныйОтчет.ДобавитьДополнительноеПоле("БазоваяЕдиницаИзмерения");
	//УниверсальныйОтчет.ДобавитьДополнительноеПоле("СуммаВРознице");
