...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ДобавитьПолеРесурс(
		"СтоимостьБезНДС",
		"СтоимостьОборот-НДСОборот",
		"Стоимость (без НДС)");
	
	УниверсальныйОтчет.ДобавитьПолеРесурс(
		"КоличествоЕдиницОтчетов",
		"КоличествоОборот*Номенклатура.ЕдиницаХраненияОстатков.Коэффициент/Номенклатура.ЕдиницаДляОтчетов.Коэффициент",
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьБезНДС",         "Стоимость  (без НДС)",       		  Истина, "ЧЦ=15; ЧДЦ=2");
	...
	УниверсальныйОтчет.ДобавитьИзмерениеСтроки("СтатусПартии");
