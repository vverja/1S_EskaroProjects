...
Функция СформироватьЗаголовок() Экспорт
	...
	СтрокаОписанияОтборов = УправлениеОтчетами.СформироватьСтрокуОтборов(ПостроительОтчета.Отбор);
	СтрФильтры = СтрФильтры + ?(Не ПустаяСтрока(СтрокаОписанияОтборов), ", "+СтрокаОписанияОтборов, "");
	СтрФильтры = Сред(СтрФильтры, 3);
...
Функция ЗаголовокОтчета() Экспорт
	Возврат "Карточка счета " + Счет + " (налоговый)";
...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок = Истина, ВысотаЗаголовка = 0) Экспорт
	...
	БухгалтерскиеОтчеты.ДополнитьСтрокуОграниченийПоРеквизитам(СтрокаОграниченийПоРеквизитам, "Организация", Организация);
	СтрокаОграниченийПоРеквизитам = БухгалтерскиеОтчеты.ОбъединитьОграничения(СтрокаОграниченийПоРеквизитам, "(Счет В ИЕРАРХИИ (&СчетАнализа))");
