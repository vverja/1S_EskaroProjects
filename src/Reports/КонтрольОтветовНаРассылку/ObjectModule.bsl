...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	ТекстЗапроса =
		...
		|	ПРЕДСТАВЛЕНИЕ(РассылкаАнкетПолучатели.Объект),
		|	ВЫБОР
		...
		|	ПРЕДСТАВЛЕНИЕ(РассылкаАнкетПолучатели.Получатель),
		|	РассылкаАнкетПолучатели.Ссылка КАК Рассылка,
		|	ПРЕДСТАВЛЕНИЕ(РассылкаАнкетПолучатели.Ссылка) КАК РассылкаПредставление,
		...
		|					И (РассылкаАнкетПолучатели.Ссылка = &ПервичнаяРассылка
		|						ИЛИ РассылкаАнкетПолучатели.Ссылка.ПервичнаяРассылка = &ПервичнаяРассылка)
		|				ИЛИ РассылкаАнкетПолучатели.Объект = Опрос.ОпрашиваемоеЛицо
		|					И (РассылкаАнкетПолучатели.Ссылка = &ПервичнаяРассылка
		|						ИЛИ РассылкаАнкетПолучатели.Ссылка.ПервичнаяРассылка = &ПервичнаяРассылка))
		|			И РассылкаАнкетПолучатели.Ссылка.Анкета = Опрос.ТиповаяАнкета}
		...
		|		{ЛЕВОЕ СОЕДИНЕНИЕ Документ.Опрос КАК Опрос
		|		ПО (РассылкаАнкетПолучатели.Объект = Опрос.ОпрашиваемоеЛицо
		|					И РассылкаАнкетПолучатели.Ссылка.ПервичнаяРассылка = &ПервичнаяРассылка
		|				ИЛИ РассылкаАнкетПолучатели.Объект = Опрос.ОпрашиваемоеЛицо
		|					И РассылкаАнкетПолучатели.Ссылка.ПервичнаяРассылка = &ПервичнаяРассылка
		|					И РассылкаАнкетПолучатели.Ссылка.Анкета = Опрос.ТиповаяАнкета)}
		|		{ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ РАЗЛИЧНЫЕ
		...
		|		ПО (РассылкаАнкетПолучатели.Ссылка = ПустыеОпросы.Ссылка.Рассылка
		|				ИЛИ РассылкаАнкетПолучатели.Ссылка.ПервичнаяРассылка = ПустыеОпросы.Ссылка.Рассылка)}
		|		//СОЕДИНЕНИЯ
		|ГДЕ
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "РассылкаАнкетПолучатели.Объект" , "Объект", "Опрашиваемое лицо", ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_Контрагенты);
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "РассылкаАнкетПолучатели.Объект" , "Объект", "Опрашиваемое лицо", ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_ФизическиеЛица);
