...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	Если ИспользоватьСвойстваИКатегории Тогда
		...
		НоваяСтрока = ТаблицаПолей.Добавить();
		НоваяСтрока.ПутьКДанным = "События.Комментарий";
		НоваяСтрока.Представление = "Комментарий";
		//НоваяСтрока.Назначение = ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.;
...
Процедура ВывестиСтроки(Таб, Макет, ТекущаяВыборка, ИндексТекущейГруппировки)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если НаименованиеГруппировки = мИмяГруппировкиДокумента Тогда
			...
			Секция.Параметры.Комментарий = Событие.Комментарий;
