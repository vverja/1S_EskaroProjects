...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ИмяРегистра = "ПланируемыеПоступленияДенежныхСредств";
	...
	УниверсальныйОтчет.ДобавитьПолеГруппировка("ФормаОплаты",           "ДокументПланирования", "ФормаОплаты",         "Наличные, безналичные");
	УниверсальныйОтчет.ДобавитьПолеГруппировка("ВалютаДенежныхСредств", "ДокументПланирования", "ВалютаДокумента",     "Валюта денежных средств");
	УниверсальныйОтчет.ДобавитьПолеГруппировка("БанковскийСчетКасса",   "ДокументПланирования", "БанковскийСчетКасса", "Банковский счет, касса");
	УниверсальныйОтчет.ДобавитьПолеГруппировка("Ответственный",         "ДокументПланирования", "Ответственный",       "Ответственный");
	УниверсальныйОтчет.ДобавитьПолеГруппировка("Подразделение",         "ДокументПланирования", "ЦФО",                 "Подразделение");
	...
	УниверсальныйОтчет.ДобавитьИзмерениеСтроки("ДокументПланирования");
