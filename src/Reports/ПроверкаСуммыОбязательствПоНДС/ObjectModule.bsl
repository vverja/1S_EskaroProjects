...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "ВыписаноНН",					"Зарегистрировано налоговых документов");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "ПериодДень",					"Дата возникновения обязательств");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ВыписаноНН", "Зарегистрировано налоговых документов", Истина, "ЧЦ=15; ЧДЦ=3");
