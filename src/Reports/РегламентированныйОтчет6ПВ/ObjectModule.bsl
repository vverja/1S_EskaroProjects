...
ОписаниеТиповСтрока26  = ОбщегоНазначения.ПолучитьОписаниеТиповСтроки(26);
...
мТаблицаСоставПоказателей.Колонки.Добавить("ИмяПоляТаблДокумента",    ОписаниеТиповСтрока26);
...
// В колонкёах таблицы хранятся следующие данные:
