...
НоваяФорма.ФормаОтчета        = "ФормаОтчета2005Кв2";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом ГНАУ  30.05.97  N 166 (в редакции приказа ГНАУ от 15.06.2005 № 213)';uk='Затверджена наказом ДПАУ  30.05.97  N 166 (у редакції наказу ДПАУ від 15.06.2005 № 213)'");
НоваяФорма.ДатаНачалоДействия = '20050601';
НоваяФорма.ДатаКонецДействия  = '20070630';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2007Кв3";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом ГНАУ  30.05.97  N 166 (в редакции приказа ГНА от 20.08.2007 № 498)';uk='Затверджена наказом ДПАУ  30.05.97  N 166 ((у редакції наказу ДПА України від 20.08.2007 № 498))'");
НоваяФорма.ДатаНачалоДействия = '20070701';
НоваяФорма.ДатаКонецДействия  = '20071231';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2008Кв1";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом ГНАУ  30.05.97  N 166 (в редакции приказа ГНА от 17.03.2008 № 159)';uk='Затверджена наказом ДПАУ  30.05.97  N 166 ((у редакції наказу ДПА України від 17.03.2008 № 159))'");
НоваяФорма.ДатаНачалоДействия = '20080101';
НоваяФорма.ДатаКонецДействия  = '20090209';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2009Кв1";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом ГНАУ  30.05.97  N 166 (в редакции приказа ГНА от 21.01.2009 № 8)';uk='Затверджена наказом ДПАУ  30.05.97  N 166 ((у редакції наказу ДПА України від 21.01.2009 № 8))'");
НоваяФорма.ДатаНачалоДействия = '20090131';
НоваяФорма.ДатаКонецДействия  = '20090430';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2010Кв2";
НоваяФорма.ОписаниеОтчета     = НСтр("ru = 'Утверждена приказом ГНАУ  30.05.97  N 166 (в ред. приказа № 221 от 28.04.2009, с изм. по Приказу №313 от 12.05.2010)'; uk = 'Затверджена наказом ДПАУ  30.05.97  N 166 (у ред. наказу № 221 від 28.04.2009, зі змінами за Наказом №313 від 12.05.2010)'");
НоваяФорма.ДатаНачалоДействия = '20100601';
НоваяФорма.ДатаКонецДействия  = '20110228';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2009Кв2";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом ГНАУ  30.05.97  N 166 (в редакции приказа ГНА от 28.04.2009 № 221)';uk='Затверджена наказом ДПАУ  30.05.97  N 166 ((у редакції наказу ДПА України від 28.04.2009 № 221))'");
НоваяФорма.ДатаНачалоДействия = '20090430';
НоваяФорма.ДатаКонецДействия  = '20100531';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2011Кв1";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом ГНАУ  25.01.11  N 41';uk='Затверджена наказом ДПАУ  25.01.11  N 41'");
...
Если РегламентированнаяОтчетность.ИДКонфигурации() = "УПП" Тогда
	...
	НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом ГНАУ  30.05.97  N 166';uk='Затверджена наказом ДПАУ  30.05.97  N 166'");
	НоваяФорма.ДатаНачалоДействия = '20030101';
	НоваяФорма.ДатаКонецДействия  = '20050531';
КонецЕсли;
