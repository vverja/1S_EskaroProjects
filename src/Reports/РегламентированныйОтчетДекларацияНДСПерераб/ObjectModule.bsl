...
НоваяФорма.ОписаниеОтчета     = НСтр("ru = 'Утверждена приказом ГНАУ  28.04.09  N 221 (с изм. по Приказу №313 от 12.05.2010)'; uk = 'Затверджена наказом ДПАУ  28.04.09  N 221 (зі змінами за Наказом №313 від 12.05.2010)'");
НоваяФорма.ДатаНачалоДействия = '20100601';
НоваяФорма.ДатаКонецДействия  = '20110228';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2009Кв2";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом ГНАУ  28.04.09  N 221 ';uk='Затверджена наказом ДПАУ  28.04.09  N 221 '");
