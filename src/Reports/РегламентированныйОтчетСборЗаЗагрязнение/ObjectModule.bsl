...
НоваяФорма.ФормаОтчета        = "ФормаОтчета2008Кв3";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Расчет сбора за загрязнение окружающей природной среды утверждено Приказом ГНАУ от 17.03.2005 №111(в редакции приказа от 03.04.2008 г. №206) ';uk='
|Розрахунок збору за забруднення навколишнього природного серердовища затверджено наказом ДПА України 17.03.2005 №111 (у редакції наказу від 03.04.2008р №206'");
