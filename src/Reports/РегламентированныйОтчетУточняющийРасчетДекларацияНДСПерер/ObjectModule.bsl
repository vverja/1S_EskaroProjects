...
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Приложение 3 к Порядку заполнения и подачи декларации по налогу на добавленную стоимость(перерабатывающее предприятие)';uk='Додаток 3 до Порядку заповнення й подачі декларації по податку на додану вартість(переробне підприємство)'");
НоваяФорма.ДатаНачалоДействия = '20090401';
НоваяФорма.ДатаКонецДействия  = '20110228';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2011Кв1";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Форма уточняющего расчета налоговых обязательств из НДС в связи с исправлением самостоятельно обнаруженной ошибки(относительно деятельности в соответствии с пунктом 1 подраздела 2 раздела XX Кодекса), утвержденная указом ГНА Украины №41 от 25.01.2011';uk='Форма уточнюючого розрахунку податкових зобов''язань з ПДВ у зв''язку з виправленням самостійно виявлених помилок(щодо діяльності відповідно до пункту 1 підрозділу 2 розділу ХХ Кодексу), затверджена наказом ДПА України №41 від 25.01.2011'");
