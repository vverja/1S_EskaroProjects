...
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Приложение 4 к Порядку заполнения и подачи декларации по налогу на добавленную стоимость';uk='Додаток 6 до Порядку заповнення й подачі декларації по податку на додану вартість'");
НоваяФорма.ДатаНачалоДействия = '20090131';
НоваяФорма.ДатаКонецДействия  = '20110228';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2005Кв4";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Приложение 6 к Порядку заполнения и подачи декларации по налогу на добавленную стоимость';uk='Додаток 6 до Порядку заповнення й подачі декларації по податку на додану вартість'");
НоваяФорма.ДатаНачалоДействия = '19990331';
НоваяФорма.ДатаКонецДействия  = '20090130';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2011Кв1";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Форма уточняющего расчета налоговых обязательств из НДС в связи с исправлением самостоятельно обнаруженной ошибки(относительно деятельности в соответствии со статьей 209 раздела V Кодекса), утвержденная указом ГНА Украины №41 от 25.01.2011';uk='Форма уточнюючого розрахунку податкових зобов''язань з ПДВ у зв''язку з виправленням самостійно виявлених помилок(щодо діяльності відповідно до статті 209 розділу V Кодексу), затверджена наказом ДПА України №41 від 25.01.2011'");
