...
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Приложение 7 к Порядку заполнения и подачи декларации по налогу на добавленную стоимость(специальной)';uk='Додаток 7 до Порядку заповнення й подачі декларації по податку на додану вартість(специальной)'");
НоваяФорма.ДатаНачалоДействия = '20100601';
НоваяФорма.ДатаКонецДействия  = '20110228';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2011Кв1";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Форма уточняющего расчета налоговых обязательств из НДС в связи с исправлением самостоятельно обнаруженной ошибки(относительно деятельности в соответствии с пунктом 209.18 статьи 209 раздела V Кодекса), утвержденная указом ГНА Украины №41 от 25.01.2011';uk='Форма уточнюючого розрахунку податкових зобов''язань з ПДВ у зв''язку з виправленням самостійно виявлених помилок(щодо діяльності відповідно до пункту 209.18 статті 209 розділу V Кодексу), затверджена наказом ДПА України №41 від 25.01.2011'");
