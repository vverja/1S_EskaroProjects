...
НоваяФорма.ОписаниеОтчета     = "Додаток до Положення ( стандарту) бухгалтерського обліку 3 (Наказ Міністерства фінансів України від 31.03.99 р. №87)";
НоваяФорма.ДатаНачалоДействия = '19990331';
НоваяФорма.ДатаКонецДействия  = '20071231';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2008Кв1";
НоваяФорма.ОписаниеОтчета     = "Додаток до Положення ( стандарту) бухгалтерського обліку 3 (зі змінами, внесеними наказом МФУ № 353 від 05.03.2008 р.)";
НоваяФорма.ДатаНачалоДействия = '20080101';
НоваяФорма.ДатаКонецДействия  = '20090930';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2009Кв4";
НоваяФорма.ОписаниеОтчета     = "Додаток до Положення ( стандарту) бухгалтерського обліку 3 (зі змінами, внесеними наказом МФУ № 1125 від 25.09.2009 р.)";
НоваяФорма.ДатаНачалоДействия = '20091001';
НоваяФорма.ДатаКонецДействия  = '20110331';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2011Кв2";
НоваяФорма.ОписаниеОтчета     = "Додаток до Положення ( стандарту) бухгалтерського обліку 3 (зі змінами, внесеними наказом МФУ № 372 від 18.03.2011 р.)";
