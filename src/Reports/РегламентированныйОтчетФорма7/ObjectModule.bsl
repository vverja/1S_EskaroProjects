...
НоваяФорма.ФормаОтчета        = "ФормаОтчета2007Кв4";
НоваяФорма.ОписаниеОтчета     =  НСтр("ru='Приложение к Положению о порядке расчета налоговых разниц по данным бухгалтреского учета (приказ Министерства финансов Украины "
" № 45 от 20.01.2007 г. )';uk='Додаток до Положення про порядок розрахунку податкових різниць за даними бухгалтерського обліку (наказ Міністерства фінансів України "
" № 45 від 20.01.2007 р.  )'");
НоваяФорма.ДатаНачалоДействия = '20071001';
