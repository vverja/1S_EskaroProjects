...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	|	ПРЕДСТАВЛЕНИЕ(РаботникиОрганизации.Сотрудник.ФизЛицо),
	...
	УниверсальныйОтчет.ДобавитьИзмерениеСтроки("ФизЛицоОтношениеКВоинскомуУчету");
	...
	УниверсальныйОтчет.ДобавитьОтбор("ФизЛицоВозраст", Истина, ВидСравнения.Равно, 17);
