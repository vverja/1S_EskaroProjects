...
Функция ВозвратитьВидаОтбораПоСтроке(СтрокаОтбора) Экспорт
	...
	ИначеЕсли СтрокаОтбора = "В ГРУППЕ" ИЛИ СтрокаОтбора = "В ГРУПІ" Тогда
		ЗначениеВозврата = ВидСравнения.ВИерархии;
	ИначеЕсли СтрокаОтбора = "НЕ В ГРУППЕ" ИЛИ СтрокаОтбора = "НЕ В ГРУПІ" Тогда
...
Функция СформироватьТекстЗапроса(Источник,КопияГруппировкиОтчета, Первый = Ложь)
		...
		Если Найти(ОписаниеФильтра, ".Свойство") > 0 Тогда
			...
			Если НайдСтрока <> Неопределено Тогда
				...
				Если    Врег(СтрокаФильтры.ТипФильтра) = "РАВНО" 				ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "ДОРІВНЮЄ"
					ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "В СПИСКЕ"             ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "В СПИСКУ"
					ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "В ГРУППЕ ИЗ СПИСКА"   ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "В ГРУПІ ЗІ СПИСКУ"
					ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "В ГРУППЕ" 			ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "В ГРУПІ" Тогда
				...
				ИначеЕсли Врег(СтрокаФильтры.ТипФильтра) = "НЕ РАВНО"                ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "НЕ ДОРІВНЮЄ"
					  ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "НЕ В СПИСКЕ"             ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "НЕ В СПИСКУ"
					  ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "НЕ В ГРУППЕ ИЗ СПИСКА"   ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "НЕ В ГРУПІ ЗІ СПИСКУ"
					  ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "НЕ В ГРУППЕ" 			 ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "НЕ В ГРУПІ" Тогда
	...
	ИначеЕсли Врег(СтрокаФильтры.ТипФильтра) = "В ГРУППЕ" ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "В ГРУПІ" Тогда
		ОператорСравнения = " В ИЕРАРХИИ ";
	ИначеЕсли Врег(СтрокаФильтры.ТипФильтра) = "НЕ В ГРУППЕ" ИЛИ Врег(СтрокаФильтры.ТипФильтра) = "НЕ В ГРУПІ" Тогда
		ОператорСравнения = " НЕ В ИЕРАРХИИ ";
	КонецЕсли;
